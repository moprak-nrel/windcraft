...
class Fonts():
    ...
    def __init__(self):
        ...
        self.types = {'small': pygame.font.Font(self.font_path,
                                                int(self.screenheight / 50)),
                      'medium': pygame.font.Font(self.font_path,
                                                 int(self.screenheight / 40)),
                      'large': pygame.font.Font(self.font_path,
                                                int(self.screenheight / 30))}
